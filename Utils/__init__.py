...
from Utils.Printer import printer_queue, thread_output_stream

MODULES_DIR = ISAFModules.__path__[0]
CREDS_DIR = os.path.join(MODULES_DIR, 'Credentials')
EXPLOITS_DIR = os.path.join(MODULES_DIR, 'Exploits')
SCANNERS_DIR = os.path.join(MODULES_DIR, 'Scanners')
CLIENTS_DIR = os.path.join(MODULES_DIR, 'Clients')
